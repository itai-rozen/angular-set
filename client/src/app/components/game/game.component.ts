...
@Component({
    ...
    imports: [CardComponent, NgFor, TimerComponent, GameBoardComponent, FinishModalComponent],
...
export class GameComponent {
  ...
  allSameOrUnique = (arr: number[] | string[]): boolean => {
